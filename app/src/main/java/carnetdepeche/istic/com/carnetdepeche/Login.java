...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("781348658663-jvm75ab4vp9n7nu7106oquen3m7g981u.apps.googleusercontent.com")
                .requestEmail()
                .build();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (result.isSuccess()) {
                ...
                Toast.makeText(this, "Connecté : " + account.getEmail().toString(), Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.btn_google_login) {
            signIn();
        } else if (i == R.id.btn_logout) {
            signOut();
            Toast.makeText(this, "Déconnexion user", Toast.LENGTH_SHORT).show();
        }
    }
}
